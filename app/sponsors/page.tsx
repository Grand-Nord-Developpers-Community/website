...
const SponsorShowcase = () => {
  ...
  return (
    <section className="bg-slate-50 dark:bg-card/50 relative overflow-hidden">
      ...
      >
        <Card className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2  shadow-lg border-0 max-lg:w-[90%] lg:max-w-screen-lg backdrop-blur-sm">
      ...
      <div className="container mx-auto px-4 py-32 relative">
        ...
        >
          {ourSponsors.map((sponsor, index) => (
            <motion.div
              ...
              className="group"
            >
              <Card className=" shadow-lg hover:shadow-2xl transition-all duration-500 rounded-2xl overflow-hidden h-full border-0 relative group-hover:ring-2 group-hover:ring-border">
                {/* Premium badge */}
                <div className="absolute top-4 right-4 z-10">
                  <motion.div
                    className="bg-amber-200 p-2 rounded-full shadow-md"
                ...
                <CardContent className="p-8 flex flex-col items-center h-full relative">
                  ...
                  <motion.div
                    className="w-36 h-36 relative mb-8 rounded-2xl bg-card/50 p-6 flex items-center justify-center shadow-inner border-2 border-border"
                    animate={{
                  ...
                  <h3 className="text-2xl font-bold mb-6 text-center text-primary tracking-tight leading-tight">
                    {sponsor.name}
                  </h3>
        ...
        >
          <div className="bg-card rounded-2xl shadow-xl p-8 max-w-md mx-auto border-0">
            <h3 className="text-2xl font-bold ">Rejoignez Notre Réseau</h3>
