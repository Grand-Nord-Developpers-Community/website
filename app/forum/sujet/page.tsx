  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <p className="mb-4">
        ...
        <a href="/codeofconduct" className="text-primary hover:underline">
          règles de conduite
        </a>{" "}
        avant de continuer.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          {activeTab === "help" && (
            <div className="border p-4 h-60 overflow-auto">{helpContent}</div>
          )}
        </div>

        <p className="mb-4 text-sm">
          Pour le formatage du code (couleur syntaxique, langage, etc.) nous
          utilisons{" "}
      ...
      >
        ...
        <p>
          Veuillez rechercher votre question avant de publier votre sujet en
          utilisant le champ de recherche dans la barre de navigation pour voir
