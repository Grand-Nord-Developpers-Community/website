...
"
      ...
      <p>
        ...
        environnement inclusif pour tous. Évitez d'utiliser un langage ou des
        images inappropriés, et soyez toujours attentif aux différences
      ...
      <p>
        ...
        bienveillante et respectueuse. Cherchez à comprendre avant de vous faire
        comprendre. Une communication efficace est la clé d'une collaboration
        réussie.
      </p>
      ...
      <p>
        Agissez toujours avec intégrité et honnêteté. Présentez des informations
        précises et évitez de diffuser des rumeurs ou des informations non
        vérifiées. Respectez les droits d'auteur et les licences de propriété
        intellectuelle. Soyez transparent dans vos actions et vos intentions.
      </p>
      ...
      <p>
        Si vous êtes témoin d'un comportement inapproprié ou d'une violation de
        ce code de conduite, signalez-le immédiatement aux modérateurs de la
        communauté. Toutes les plaintes seront examinées et traitées de manière
        confidentielle pour protéger les parties impliquées.
      </p>
      ...
      <p>
        ...
        promouvoir l'innovation, partager les compétences technologiques, et
        résoudre les défis locaux à travers des solutions collaboratives. Nous
        nous engageons à créer un environnement propice à l'apprentissage, au
        développement personnel et à l'entraide.
      </p>
      ...
      <p>
        Ce code de conduite s'applique à tous les espaces communautaires, qu'ils
        soient en ligne ou hors ligne, ainsi qu'à toutes les personnes
        représentant la communauté dans des espaces publics. Cela inclut les
        forums de discussion, les réseaux sociaux, les événements, et toute
        autre interaction publique.
      </p>

      <h2 className="text-xl font-bold mb-2">Application</h2>
      <p>
        Les cas de comportement abusif, de harcèlement ou autrement inacceptable
        peuvent être signalés aux modérateurs de la communauté à [insérer les
        coordonnées]. Toutes les plaintes seront examinées de manière rigoureuse
        et aboutiront à une réponse jugée nécessaire et appropriée aux
        circonstances. Les modérateurs sont tenus de maintenir la
        confidentialité des plaignants pour garantir un environnement sûr et
        respectueux.
      </p>
      ...
      <p>
        ...
        croyons fermement que la diversité et l'inclusion sont des forces qui
        nous permettront de réussir et d'innover ensemble.
      </p>
