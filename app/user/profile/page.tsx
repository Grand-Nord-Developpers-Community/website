    ...
    <div className="max-w-full mx-auto p-0">
      <div className="bg-gray-100 p-6 mb-6">
        ...
        <Image
          ...
          <div>
            <h1 className="text-2xl font-bold">Isaac Touza</h1>
            <p className="text-sm text-gray-600">Inscrit il y a 4 ans</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-gray-700">Fullstack Developer - Laravel, Kotlin & React Developer. GNDC Organizer @gndc | @2zalab</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold mb-2">Localisation</h2>
            <p className="text-gray-700">Maroua, Cameroun</p>
            <h2 className="text-lg font-semibold mt-4 mb-2">Site internet</h2>
          ...
          <div key={index} className="flex items-start">
            ...
            <div>
              ...
              <div className="flex items-center">
                <Image src={touzaImage} alt="Isaac Touza" width={24} height={24} className="rounded-full mr-2" />
