...
const OurLeadersSection = () => {
    const [leaderDetails, setLeaderDetails] = useState(Array(leaders.length).fill(false))
            ...
            <div className="grid sm:grid-cols-12 items-start gap-4">
                <div className="sm:col-span-5">
                    ...
                    <p className="text-xl leading-normal">
                        GNDC est dirigée par une équipe de leaders passionnés et visionnaires, dévoués à l'innovation technologique et à l'enseignement dans le Grand Nord Cameroun.
                    </p>
                </div>
                        ...
                        {leaders.map((leader, index) => {
                            return (
                                <div className="w-auto p-4 border-1 border-gray-300 flex flex-col justify-center items-center cursor-pointer" 
                                    ...
                                    <div className={cn("mt-2 z-50 max-sm:block", leaderDetails[index] ? "block" : "hidden")}>
                                        <h4 className="text-lg text-black font-bold text-center">{leader.name}</h4>
