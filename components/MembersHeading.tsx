...
const MembersHeading = () => {
  ...
  const handleBecomeMember = () => {
    if (email != "" && name != "") {
      router.push(`/bemember?name=${name}&email=${email}`);
    }
  };
  return (
        ...
        <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
          <div className="text-center">
            ...
            <h1 className="text-2xl text-white font-bold sm:text-4xl lg:text-5xl lg:leading-tight">
              ...
              <span className="text-secondary">du Grand Nord Cameroun</span>
            </h1>
          </div>
          ...
          <div className="sm:flex sm:justify-center sm:items-center text-center sm:text-start">
            ...
            <div className="pt-5 sm:pt-0 sm:ps-5">
              ...
              <div className="text-sm text-gray-50">
                Un réseau ambitieux avec 200+ membres actifs
              </div>
            </div>
          </div>

          <form>
            <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-primary">
              ...
              <div className="whitespace-nowrap pt-2 sm:pt-0 grid sm:block">
                <button
                  className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-secondary text-white hover:opacity-90 focus:outline-none focus:opacity-90 disabled:opacity-50 disabled:pointer-events-none"
